...
<body>
	...
	<form  name="form" method="post" onclick="return validate()">
		<span id="valid"></span>
		<div class="container">
			...
			<div class="row">
				...
				DOB :<span id="errorDob" style="color: red"></span><input type="date" id="dob" name="dob" class="form-control"
					onchange="dobHandle()" /> 
			...
			<div class="row">
				Confirm Password <input type="password" name="confirmPassword"
					id="confirmPassword" class="form-control" onchange="passwordHandle()"/><span
					id="errorConfirm" style="color: red"></span>
			</div>
			<br>
